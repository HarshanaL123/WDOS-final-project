...
function checkLoyaltypoints(){
  ...
  // Rooms loyalty points calculation
 ...
 // alert(loyaltyMessage);
  document.getElementById('LoyaltyPoints').innerText=`${loyaltyPoints}`; //Loyalty point Display in fieldset
...
//  Adventure Booking Calculations
...
//alert message in local storage*****************************
